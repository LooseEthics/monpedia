...
550 => [:Tartarus （Esta）],
551 => [:Tartarus （West Hellgondo）, :イリアス神殿（混沌）],
552 => [:Tartarus （Esta）, :邪神城（混沌）],
...
556 => [:"Administrator's Tower （AD）", :"Administrator's Tower （AD）", :Around Sabasa （AD）, :"Water Spirit's Spring （AD）", :Safar Ruins （AD）],
...
834 => [:Central Tartarus, :深き混沌（混沌）],
835 => [:Central Tartarus, :深き混沌（混沌）],
836 => [:Central Tartarus, :深き混沌（混沌）],
837 => [:Central Tartarus, :深き混沌（混沌）],
838 => [:Central Tartarus, :深き混沌（混沌）],
839 => [:Central Tartarus, :深き混沌（混沌）],
...
846 => [:エンリカ（混沌）],
847 => [:イリアスヴィルの裏山（混沌）],
848 => [:Ilias Temple （Chaos）, :グランドノア（混沌）],
849 => [:Ilias Temple （Chaos）, :グランドノア（混沌）],
850 => [:聖山アモス（混沌）],
851 => [:グランゴルド（混沌）],
852 => [:グランドノア（混沌）, :水精の泉（混沌）],
853 => [:魔導学園（混沌）],
854 => [:魔導学園（混沌）],
855 => [:魔導学園（混沌）],
856 => [:サバサ（混沌）],
...
863 => [:月面の機械要塞（混沌）, :Alliance of Wisdom Laboratory （Chaos）],
864 => [:月面の機械要塞（混沌）],
865 => [:ハーピーの集落（混沌）],
866 => [:ハーピーの集落（混沌）],
867 => [:精霊の森（混沌）],
...
972 => [:カオスの領域（混沌）],
973 => [:カオスの領域（混沌）],
974 => [:Ilias Temple Ruins （混沌）, :Black Mansion（混沌）, :カオスの領域（混沌）],
975 => [:カオスの領域（混沌）],
976 => [:カオスの領域（混沌）],
977 => [:カオスの領域（混沌）],
978 => [:カオスの領域（混沌）],
...
2100 => [:求道者の洞窟（混沌）],
2101 => [:Sabasa Desert （Chaos）, :ピラミッド（混沌）],
2102 => [:Sabasa Desert （Chaos）, :恵みのオアシス（混沌）],
2103 => [:Sabasa Desert （Chaos）, :恵みのオアシス（混沌）],
2104 => [:Sabasa Desert （Chaos）],
2105 => [:ピラミッド（混沌）],
2106 => [:Sabasa Desert （Chaos）, :ピラミッド（混沌）],
2107 => [:ピラミッド（混沌）],
2108 => [:黄泉比良坂（混沌）],
2109 => [:ピラミッド（混沌）],
2111 => [:Sabasa Desert （Chaos）, :Sabasa Desert （Chaos）, :恵みのオアシス（混沌）],
2112 => [:恵みのオアシス（混沌）],
...
2201 => [:魔導学園（混沌）],
2202 => [:魔導学園（混沌）],
2204 => [:Around Esta （混沌）, :ゲシュタルト・ハイブマインド（混沌）],
2205 => [:Around Esta （混沌）, :ゲシュタルト・ハイブマインド（混沌）],
2206 => [:プランセクト村（混沌）],
2207 => [:プランセクト村（混沌）],
2208 => [:プランセクト村（混沌）],
2209 => [:プランセクト村（混沌）],
...
2230 => [:水精の泉（混沌）],
2231 => [:光の塔と闇の塔（混沌）],
2233 => [:ゴッダール周辺（混沌）, :リマ村廃墟（混沌）, :Gold Fort （Chaos）, :ゲシュタルト・ハイブマインド（混沌）],
2234 => [:リマ村廃墟（混沌）, :Gold Fort （Chaos）],
...
2334 => [:ヘルゴンドの洞窟（混沌）],
2335 => [:ヘルゴンドの洞窟（混沌）],
2336 => [:Hellgondo Continent （Chaos）, :ヘルゴンドの洞窟（混沌）],
2337 => [:Hellgondo Continent （Chaos）, :ヘルゴンドの洞窟（混沌）],
2338 => [:Hellgondo Continent （Chaos）, :邪神城（混沌）],
2339 => [:Hellgondo Continent （Chaos）, :邪神城（混沌）],
...
2353 => [:スノウヘブン周辺（混沌）, :Ilias Temple （混沌）, :雪越えの洞窟（混沌）],
2354 => [:スノウヘブン周辺（混沌）, :Ilias Temple （混沌）, :雪越えの洞窟（混沌）],
2355 => [:スノウヘブン周辺（混沌）, :Ilias Temple （混沌）, :雪越えの洞窟（混沌）],
2356 => [:スノウヘブン周辺（混沌）, :Ilias Temple （混沌）, :雪越えの洞窟（混沌）],
2357 => [:スノウヘブン周辺（混沌）, :Ilias Temple （混沌）, :雪越えの洞窟（混沌）],
2358 => [:スノウヘブン周辺（混沌）],
2359 => [:スノウヘブン周辺（混沌）],
2360 => [:スノウヘブン周辺（混沌）],
2361 => [:Around Esta （混沌）, :スノウヘブン周辺（混沌）, :雪のほこら（混沌）, :創世の館（混沌）],
2362 => [:Around Esta （混沌）, :スノウヘブン周辺（混沌）, :雪のほこら（混沌）, :創世の館（混沌）],
2363 => [:Around Esta （混沌）, :Ilias Temple （混沌）, :雪のほこら（混沌）, :創世の館（混沌）],
2364 => [:Around Esta （混沌）, :Ilias Temple （混沌）, :雪のほこら（混沌）, :創世の館（混沌）],
2366 => [:Ilias Temple Ruins （混沌）],
2367 => [:Ilias Temple Ruins （混沌）],
2368 => [:カオスの領域（混沌）],
2369 => [:カオスの領域（混沌）],
2370 => [:カオスの領域（混沌）],
2373 => [:滅びの地（混沌）],
...
2376 => [:滅びの地（混沌）],
2377 => [:滅びの地（混沌）],
2378 => [:Ilias Temple Ruins （混沌）],
2379 => [:Ilias Temple Ruins （混沌）],
2380 => [:Ilias Temple Ruins （混沌）],
2381 => [:Ilias Temple Ruins （混沌）],
2382 => [:Ilias Temple Ruins （混沌）],
2383 => [:Ilias Temple Ruins （混沌）],
2385 => [:カオスの領域（混沌）],
2396 => [:大罪の殿堂（混沌）],
2501 => [:光の塔と闇の塔（混沌）],
...
2551 => [:カオスの領域（混沌）],
2552 => [:カオスの領域（混沌）],
2554 => [:Around Esta （混沌）, :水精の泉（混沌）],
2555 => [:Around Esta （混沌）, :水精の泉（混沌）],
2556 => [:Sabasa Desert （Chaos）, :水精の泉（混沌）, :Safar Ruins （Chaos））],
2558 => [:Sabasa Desert （Chaos）, :Safar Ruins （Chaos））],
2559 => [:Sabasa Desert （Chaos）, :Safar Ruins （Chaos））, :雪のほこら（混沌）, :創世の館（混沌）],
2562 => [:Sabasa Desert （Chaos）, :Safar Ruins （Chaos））, :雪のほこら（混沌）, :創世の館（混沌）],
...
2579 => [:ゴルド火山洞窟（混沌）],
2584 => [:Hellgondo Continent （Chaos）, :レミナ研究所（混沌）],
2585 => [:Hellgondo Continent （Chaos）, :レミナ研究所（混沌）],
2586 => [:Hellgondo Continent （Chaos）, :レミナ研究所（混沌）],
2587 => [:Hellgondo Continent （Chaos）, :レミナ研究所（混沌）],
2589 => [:レミナ研究所（混沌）],
2590 => [:レミナ研究所（混沌）],
2592 => [:レミナ研究所（混沌）],
2593 => [:レミナ研究所（混沌）],
2595 => [:Ilias Temple （混沌）],
2596 => [:レミナ研究所（混沌）],
2597 => [:月面の機械要塞（混沌）],
2598 => [:月面の機械要塞（混沌）],
2599 => [:月面の機械要塞（混沌）],
2600 => [:月面の機械要塞（混沌）],
2601 => [:Ilias Temple （混沌）],
2602 => [:Ilias Temple （混沌）],
2603 => [:ナタリアポート周辺（混沌）, :モンテカルロ周辺（混沌）, :Ilias Temple （混沌）],
...
2699 => [:グランゴルド（混沌）, :Gold Fort （Chaos）],
2700 => [:グランゴルド（混沌）, :Gold Fort （Chaos）],
2701 => [:グランゴルド（混沌）, :Gold Fort （Chaos）],
2703 => [:グランゴルド（混沌）],
2704 => [:グランゴルド（混沌）],
2705 => [:グランゴルド（混沌）],
2706 => [:グランドノア周辺（混沌）, :Around Esta （Chaos）, :グランドノア（混沌）, :Gold Fort （Chaos）],
2707 => [:グランドノア周辺（混沌）, :Around Esta （Chaos）, :グランドノア（混沌）, :Gold Fort （Chaos）],
2708 => [:グランドノア周辺（混沌）, :Around Esta （Chaos）, :グランドノア（混沌）, :水精の泉（混沌）],
2709 => [:水精の泉（混沌）],
2710 => [:グランドノア（混沌）, :水精の泉（混沌）],
2712 => [:水精の泉（混沌）],
2713 => [:ゴルド火山洞窟（混沌）],
2714 => [:ゴルド火山洞窟（混沌）],
2715 => [:Various Places（混沌）],
2716 => [:ゴルド火山洞窟（混沌）],
2717 => [:光の塔と闇の塔（混沌）],
2718 => [:水精の泉（混沌）],
2719 => [:水精の泉（混沌）],
...
2776 => [:光の塔と闇の塔（混沌）],
2778 => [:光の塔と闇の塔（混沌）],
2781 => [:Calamity Star Demiurge （Chaos）, :滅びの地（混沌）],
2782 => [:Calamity Star Demiurge （Chaos）, :滅びの地（混沌）],
2783 => [:Calamity Star Demiurge （Chaos）, :滅びの地（混沌）],
2784 => [:サバサ（混沌）],
...
2809 => [:カオスの領域（混沌）],
2811 => [:グランドノア（混沌）],
2812 => [:Hellgondo Continent （Chaos）, :光の塔と闇の塔（混沌）],
2813 => [:Hellgondo Continent （Chaos）, :光の塔と闇の塔（混沌）],
